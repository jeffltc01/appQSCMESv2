...
- **Limble Identifier** v1 did not have this field, this field was added for future functionality where work orders could be created directly against an Asset in Limble based on the Asset the user is logged into in the MES.`;export{e as default};
