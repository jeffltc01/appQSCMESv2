...
{
    Task<SpotXrayLaneQueuesDto> GetLaneQueuesAsync(Guid? siteId, string? siteCode, CancellationToken ct = default);
    ...
    Task<List<SpotXrayIncrementSummaryDto>> GetRecentIncrementsAsync(Guid? siteId, string? siteCode, CancellationToken ct = default);
    Task<List<SpotXrayIncrementSummaryDto>> GetDraftIncrementsAsync(Guid? siteId, string? siteCode, CancellationToken ct = default);
