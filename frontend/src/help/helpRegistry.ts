...
export const helpArticles: HelpArticle[] = [
  ...
  { slug: 'work-centers', title: 'Work Centers', category: 'admin', routeMatch: '/menu/workcenters' },
  { slug: 'production-line-work-centers', title: 'Production Line Work Centers', category: 'admin', routeMatch: '/menu/production-line-workcenters' },
  ...
  { slug: 'checklist-response-review', title: 'Checklist Response Review', category: 'admin', routeMatch: '/menu/checklist-response-review' },
