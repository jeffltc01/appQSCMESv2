...
const MENU_TILES: MenuTile[] = [
  ...
  { label: 'User Maintenance', icon: <PeopleRegular />, minRoleTier: 1, route: '/menu/users', implemented: true },
  ...
  { label: 'Defect Codes', icon: <ShieldErrorRegular />, minRoleTier: 2, route: '/menu/defect-codes', implemented: true },
  { label: 'Defect Locations', icon: <LocationRegular />, minRoleTier: 2, route: '/menu/defect-locations', implemented: true },
  ...
  { label: 'Characteristics', icon: <ClipboardTextLtrRegular />, minRoleTier: 2, route: '/menu/characteristics', implemented: true },
  { label: 'Control Plans', icon: <ListRegular />, minRoleTier: 2, route: '/menu/control-plans', implemented: true },
  { label: 'Plant Gear', icon: <TopSpeedRegular />, minRoleTier: 2, route: '/menu/plant-gear', implemented: true },
