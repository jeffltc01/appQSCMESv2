...
const MENU_GROUPS: MenuGroup[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { label: 'Print Routes', icon: <PrintRegular />, minRoleTier: 3, route: '/menu/plant-printers', implemented: true },
      { label: 'Issues', icon: <BugRegular />, minRoleTier: 5, route: '/menu/issues', implemented: true },
      { label: 'Workflow Definitions', icon: <BranchRegular />, minRoleTier: 2, canAccess: (t) => t <= 2, route: '/menu/workflow-definitions', implemented: true },
